...
alias Sd="systemctl --user disable"
alias Sdn="systemctl --user disable --now"
alias Se="systemctl --user enable"
alias Sen="systemctl --user enable --now"
alias Sr="systemctl --user start"
alias Ss="systemctl --user status"
alias s="systemctl"
alias sd="systemctl disable"
alias sdn="systemctl disable --now"
