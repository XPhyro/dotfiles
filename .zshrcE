...
alias ytdl='youtube-dl --add-metadata --mark-watched --geo-bypass --retries infinite --fragment-retries infinite --download-archive ~/documents/data-dump/download-archive -o "%(uploader)s_%(upload_date)s_%(id)s_%(title)s_%(timestamp)s.%(ext)s" --prefer-free-formats --merge-output-format mkv'
alias ytdlnolog='youtube-dl --add-metadata --mark-watched --geo-bypass --retries infinite --fragment-retries infinite -o "%(uploader)s_%(upload_date)s_%(id)s_%(title)s_%(timestamp)s.%(ext)s" --prefer-free-formats --merge-output-format mkv'
alias ytdlshort='youtube-dl --add-metadata --mark-watched --geo-bypass --retries infinite --fragment-retries infinite --download-archive ~/documents/data-dump/download-archive -o "%(uploader)s_%(upload_date)s_%(id)s_%(timestamp)s.%(ext)s" mkv --prefer-free-formats --merge-output-format mkv'
alias ytdlshortnolog='youtube-dl --add-metadata --mark-watched --geo-bypass --retries infinite --fragment-retries -o "%(uploader)s_%(upload_date)s_%(id)s_%(timestamp)s.%(ext)s" --prefer-free-formats --merge-output-format mkv'
